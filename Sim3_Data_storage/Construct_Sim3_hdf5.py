...
if 'General_Info' not in f1:
    ...
    GenInfostrList = ['Boron_Data', 'efpd_Data', 'Max_Pin_Data', 'Max_Assembly_Data', 'Max_Fuel_Average_Temp (K)']
    # convert to ascii
    ...
    CoreCondList = ['Percent_Thermal_Power', 'Percent_Core_Flow',
                    'Operating_Pressure_(psia)', 'Core_Inlet_Temp_(F)', 'Coolant_Average_Temp_(K)']
